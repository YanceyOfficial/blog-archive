> 最近在写一个 《JavaScript API 全解析》系列（刚写完 String，现正在写 Object，可戳 [JavaScript API 全解析](https://js.yanceyleo.com)），想把 MDN 推荐使用的 API 全部撸一遍，也算是给自己准备一份资料。因为 Object.defineProperty() 涉及到的知识点比较复杂，所以单独拎出来放到这里，欢迎大家拍砖。
